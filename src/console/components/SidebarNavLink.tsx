...
const inactiveLinkClass = 'bg-transparent font-medium text-[var(--subkit-dim)] hover:bg-[var(--subkit-panel-2)]'
...
export function SidebarNavLink({
  ...
  return (
    <Link
      ...
      to={to}
    >
      <SidebarLinkContent count={count} countLabel={countLabel} icon={icon}>{label}</SidebarLinkContent>
    </Link>
  )
}
