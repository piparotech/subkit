...
export type StoreBindingStatus = 'planned' | 'linked' | 'synced' | 'drifted' | 'missing_in_store' | 'missing_in_subkit' | 'unsupported' | 'archived'
...
export type StoreMutationPlanStatus = 'draft' | 'ready' | 'confirmation_required' | 'confirmed' | 'applying' | 'verifying' | 'applied' | 'partial' | 'failed' | 'cancelled' | 'expired' | 'superseded'
